...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/quart-cors-feedstock/blob/master/LICENSE.txt)

Summary: A Quart extension to provide Cross Origin Resource Sharing, access control, support.

Development: https://gitlab.com/pgjones/quart-cors

Documentation: https://gitlab.com/pgjones/quart-cors
...
Once the `conda-forge` channel has been enabled, `quart-cors` can be installed with:

```
conda install quart-cors
```

It is possible to list all of the versions of `quart-cors` available on your platform with:
